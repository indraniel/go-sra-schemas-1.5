...
type TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema xsdt.String

//	Since TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema is just a simple String type, this merely returns the current string value.
func (me TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema) String() string {
	return xsdt.String(me).String()
}

//	This convenience method just performs a simple type conversion to TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema's alias type xsdt.String.
func (me TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema) ToXsdtString() xsdt.String {
	return xsdt.String(me)
}

//	Returns true if the value of this enumerated TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema is "study".
func (me TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema) IsStudy() bool {
	return me.String() == "study"
}

//	Returns true if the value of this enumerated TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema is "experiment".
func (me TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema) IsExperiment() bool {
	return me.String() == "experiment"
}

//	Returns true if the value of this enumerated TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema is "sample".
func (me TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema) IsSample() bool {
	return me.String() == "sample"
}

//	Returns true if the value of this enumerated TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema is "run".
func (me TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema) IsRun() bool {
	return me.String() == "run"
}

//	Returns true if the value of this enumerated TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema is "analysis".
func (me TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema) IsAnalysis() bool {
	return me.String() == "analysis"
}

//	Since TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema is just a simple String type, this merely sets the current value from the specified string.
func (me *TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema) Set(s string) {
...
type XsdGoPkgHasAttr_Schema_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema_ struct {
	//	Select a source type (schema) for the file. This will actually be required by the business
	//	layer if the source documentation reference aliases that are not unique outside of their document type.
	Schema TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidateSchema `xml:"schema,attr"`
}
...
//	Select an action to execute with respect to this submission session.
type XsdGoPkgHasElem_ACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Action_TxsdSubmissionTypeSequenceActionsSequenceAction_ struct {
	//	Select an action to execute with respect to this submission session.
	Action *TxsdSubmissionTypeSequenceActionsSequenceAction `xml:"ACTION"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_ACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Action_TxsdSubmissionTypeSequenceActionsSequenceAction_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_ACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Action_TxsdSubmissionTypeSequenceActionsSequenceAction_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_ACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Action_TxsdSubmissionTypeSequenceActionsSequenceAction_ instance.
func (me *XsdGoPkgHasElem_ACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Action_TxsdSubmissionTypeSequenceActionsSequenceAction_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_ACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Action_TxsdSubmissionTypeSequenceActionsSequenceAction_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	Process the submission but do not archive anything or issue valid accessions for any object.
type XsdGoPkgHasElems_VALIDATEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Validate_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidate_ struct {
	//	Process the submission but do not archive anything or issue valid accessions for any object.
	Validates []*TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidate `xml:"VALIDATE"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_VALIDATEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Validate_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidate_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_VALIDATEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Validate_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidate_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_VALIDATEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Validate_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidate_ instance.
func (me *XsdGoPkgHasElems_VALIDATEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Validate_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidate_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_VALIDATEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Validate_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidate_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type XsdGoPkgHasElem_CONTACTsequenceTxsdSubmissionTypeSequenceContactsCONTACTSsequenceSubmissionTypeschema_Contact_TxsdSubmissionTypeSequenceContactsSequenceContact_ struct {
	Contact *TxsdSubmissionTypeSequenceContactsSequenceContact `xml:"CONTACT"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_CONTACTsequenceTxsdSubmissionTypeSequenceContactsCONTACTSsequenceSubmissionTypeschema_Contact_TxsdSubmissionTypeSequenceContactsSequenceContact_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_CONTACTsequenceTxsdSubmissionTypeSequenceContactsCONTACTSsequenceSubmissionTypeschema_Contact_TxsdSubmissionTypeSequenceContactsSequenceContact_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_CONTACTsequenceTxsdSubmissionTypeSequenceContactsCONTACTSsequenceSubmissionTypeschema_Contact_TxsdSubmissionTypeSequenceContactsSequenceContact_ instance.
func (me *XsdGoPkgHasElem_CONTACTsequenceTxsdSubmissionTypeSequenceContactsCONTACTSsequenceSubmissionTypeschema_Contact_TxsdSubmissionTypeSequenceContactsSequenceContact_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_CONTACTsequenceTxsdSubmissionTypeSequenceContactsCONTACTSsequenceSubmissionTypeschema_Contact_TxsdSubmissionTypeSequenceContactsSequenceContact_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	Release content to public view and indexing for any study, experiment, sample, run, or analysis
//	object that was submitted under this submission session.
type XsdGoPkgHasElems_RELEASEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Release_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceRelease_ struct {
	//	Release content to public view and indexing for any study, experiment, sample, run, or analysis
	//	object that was submitted under this submission session.
	Releases []*TxsdSubmissionTypeSequenceActionsSequenceActionChoiceSuppress `xml:"RELEASE"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_RELEASEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Release_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceRelease_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_RELEASEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Release_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceRelease_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_RELEASEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Release_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceRelease_ instance.
func (me *XsdGoPkgHasElems_RELEASEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Release_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceRelease_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_RELEASEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Release_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceRelease_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	explicit and there is no cascade suppression. User must take care to remove only objects that do not have active
//	references.
type XsdGoPkgHasElems_SUPPRESSchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Suppress_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceSuppress_ struct {
	//	Suppress object from view, indexing, and download from public site as prescribed by INSDC rules.
	//	The object is not removed from the Archive, and can be obtained again by accession if requested. Suppression is
	//	explicit and there is no cascade suppression. User must take care to remove only objects that do not have active
	//	references.
...
//	If the WalkHandlers.XsdGoPkgHasElems_SUPPRESSchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Suppress_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceSuppress_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_SUPPRESSchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Suppress_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceSuppress_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_SUPPRESSchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Suppress_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceSuppress_ instance.
func (me *XsdGoPkgHasElems_SUPPRESSchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Suppress_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceSuppress_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_SUPPRESSchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Suppress_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceSuppress_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	Hold content from public view for any study, experiment, sample, run, or analysis object that was
//	submitted under this submission session.
type XsdGoPkgHasElems_HOLDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Hold_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceHold_ struct {
	//	Hold content from public view for any study, experiment, sample, run, or analysis object that was
	//	submitted under this submission session.
	Holds []*TxsdSubmissionTypeSequenceActionsSequenceActionChoiceHold `xml:"HOLD"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_HOLDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Hold_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceHold_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_HOLDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Hold_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceHold_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_HOLDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Hold_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceHold_ instance.
func (me *XsdGoPkgHasElems_HOLDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Hold_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceHold_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_HOLDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Hold_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceHold_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type XsdGoPkgHasElem_SubmissionLINKsequenceTxsdSubmissionTypeSequenceSubmissionLinksSUBMISSIONLINKSsequenceSubmissionTypeschema_SubmissionLink_TLinkType_ struct {
	SubmissionLink *TLinkType `xml:"SUBMISSION_LINK"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_SubmissionLINKsequenceTxsdSubmissionTypeSequenceSubmissionLinksSUBMISSIONLINKSsequenceSubmissionTypeschema_SubmissionLink_TLinkType_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_SubmissionLINKsequenceTxsdSubmissionTypeSequenceSubmissionLinksSUBMISSIONLINKSsequenceSubmissionTypeschema_SubmissionLink_TLinkType_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_SubmissionLINKsequenceTxsdSubmissionTypeSequenceSubmissionLinksSUBMISSIONLINKSsequenceSubmissionTypeschema_SubmissionLink_TLinkType_ instance.
func (me *XsdGoPkgHasElem_SubmissionLINKsequenceTxsdSubmissionTypeSequenceSubmissionLinksSUBMISSIONLINKSsequenceSubmissionTypeschema_SubmissionLink_TLinkType_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_SubmissionLINKsequenceTxsdSubmissionTypeSequenceSubmissionLinksSUBMISSIONLINKSsequenceSubmissionTypeschema_SubmissionLink_TLinkType_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type XsdGoPkgWalkHandlers struct {
	...
	XsdGoPkgHasElems_VALIDATEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Validate_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidate_                 func(*XsdGoPkgHasElems_VALIDATEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Validate_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceValidate_, bool) error
	...
	XsdGoPkgHasElems_HOLDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Hold_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceHold_                                                                                                             func(*XsdGoPkgHasElems_HOLDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Hold_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceHold_, bool) error
	...
	XsdGoPkgHasElem_CONTACTsequenceTxsdSubmissionTypeSequenceContactsCONTACTSsequenceSubmissionTypeschema_Contact_TxsdSubmissionTypeSequenceContactsSequenceContact_                                                                                         func(*XsdGoPkgHasElem_CONTACTsequenceTxsdSubmissionTypeSequenceContactsCONTACTSsequenceSubmissionTypeschema_Contact_TxsdSubmissionTypeSequenceContactsSequenceContact_, bool) error
	...
	XsdGoPkgHasElem_SubmissionLINKsequenceTxsdSubmissionTypeSequenceSubmissionLinksSUBMISSIONLINKSsequenceSubmissionTypeschema_SubmissionLink_TLinkType_                                                                                                     func(*XsdGoPkgHasElem_SubmissionLINKsequenceTxsdSubmissionTypeSequenceSubmissionLinksSUBMISSIONLINKSsequenceSubmissionTypeschema_SubmissionLink_TLinkType_, bool) error
	...
	XsdGoPkgHasElem_ACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Action_TxsdSubmissionTypeSequenceActionsSequenceAction_                                                                                               func(*XsdGoPkgHasElem_ACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Action_TxsdSubmissionTypeSequenceActionsSequenceAction_, bool) error
	...
	XsdGoPkgHasElems_RELEASEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Release_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceRelease_                    func(*XsdGoPkgHasElems_RELEASEchoiceTxsdSubmissionTypeSequenceActionsSequenceActionACTIONsequenceTxsdSubmissionTypeSequenceActionsACTIONSsequenceSubmissionTypeschema_Release_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceRelease_, bool) error
	...
	XsdGoPkgHasElems_SUPPRESSchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Suppress_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceSuppress_                                                                                                 func(*XsdGoPkgHasElems_SUPPRESSchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Suppress_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceSuppress_, bool) error
