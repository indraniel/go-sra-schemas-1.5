...
//	Add a study, experiment, sample, run, or analysis to the submission session.
type XsdGoPkgHasElems_ADDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Add_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceAdd_ struct {
	//	Add a study, experiment, sample, run, or analysis to the submission session.
	Adds []*TxsdSubmissionTypeSequenceActionsSequenceActionChoiceAdd `xml:"ADD"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_ADDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Add_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceAdd_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_ADDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Add_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceAdd_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_ADDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Add_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceAdd_ instance.
func (me *XsdGoPkgHasElems_ADDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Add_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceAdd_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_ADDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Add_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceAdd_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	Modify a study, experiment, sample, or analysis object that was submitted under this submission
//	session.
type XsdGoPkgHasElems_MODIFYchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Modify_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceModify_ struct {
	//	Modify a study, experiment, sample, or analysis object that was submitted under this submission
	//	session.
	Modifies []*TxsdSubmissionTypeSequenceActionsSequenceActionChoiceModify `xml:"MODIFY"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_MODIFYchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Modify_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceModify_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_MODIFYchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Modify_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceModify_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_MODIFYchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Modify_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceModify_ instance.
func (me *XsdGoPkgHasElems_MODIFYchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Modify_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceModify_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_MODIFYchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Modify_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceModify_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type XsdGoPkgHasElem_SubmissionATTRIBUTEsequenceSUBMISSIONATTRIBUTESsequenceSubmissionTypeschema_SubmissionAttribute_TAttributeType_ struct {
	SubmissionAttribute *TAttributeType `xml:"SUBMISSION_ATTRIBUTE"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_SubmissionATTRIBUTEsequenceSUBMISSIONATTRIBUTESsequenceSubmissionTypeschema_SubmissionAttribute_TAttributeType_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_SubmissionATTRIBUTEsequenceSUBMISSIONATTRIBUTESsequenceSubmissionTypeschema_SubmissionAttribute_TAttributeType_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_SubmissionATTRIBUTEsequenceSUBMISSIONATTRIBUTESsequenceSubmissionTypeschema_SubmissionAttribute_TAttributeType_ instance.
func (me *XsdGoPkgHasElem_SubmissionATTRIBUTEsequenceSUBMISSIONATTRIBUTESsequenceSubmissionTypeschema_SubmissionAttribute_TAttributeType_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_SubmissionATTRIBUTEsequenceSUBMISSIONATTRIBUTESsequenceSubmissionTypeschema_SubmissionAttribute_TAttributeType_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type XsdGoPkgWalkHandlers struct {
	...
	XsdGoPkgHasElems_MODIFYchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Modify_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceModify_                                                                                                       func(*XsdGoPkgHasElems_MODIFYchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Modify_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceModify_, bool) error
	...
	XsdGoPkgHasElem_SubmissionATTRIBUTEsequenceSUBMISSIONATTRIBUTESsequenceSubmissionTypeschema_SubmissionAttribute_TAttributeType_                                                                                                                          func(*XsdGoPkgHasElem_SubmissionATTRIBUTEsequenceSUBMISSIONATTRIBUTESsequenceSubmissionTypeschema_SubmissionAttribute_TAttributeType_, bool) error
	...
	XsdGoPkgHasElems_ADDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Add_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceAdd_                                                                                                                func(*XsdGoPkgHasElems_ADDchoiceACTIONsequenceACTIONSsequenceSubmissionTypeschema_Add_TxsdSubmissionTypeSequenceActionsSequenceActionChoiceAdd_, bool) error
