...
//	Set of reference IDs to parent experiment record. This block is intended to replace the use of the less
//	structured RefNameGroup identifiers.
type XsdGoPkgHasElems_IDENTIFIERSallEXPERIMENTREFsequenceRunTypeschema_Identifiers_TIdentifierType_ struct {
	//	Set of reference IDs to parent experiment record. This block is intended to replace the use of the less
	//	structured RefNameGroup identifiers.
	Identifierses []*TIdentifierType `xml:"IDENTIFIERS"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_IDENTIFIERSallEXPERIMENTREFsequenceRunTypeschema_Identifiers_TIdentifierType_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_IDENTIFIERSallEXPERIMENTREFsequenceRunTypeschema_Identifiers_TIdentifierType_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_IDENTIFIERSallEXPERIMENTREFsequenceRunTypeschema_Identifiers_TIdentifierType_ instance.
func (me *XsdGoPkgHasElems_IDENTIFIERSallEXPERIMENTREFsequenceRunTypeschema_Identifiers_TIdentifierType_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_IDENTIFIERSallEXPERIMENTREFsequenceRunTypeschema_Identifiers_TIdentifierType_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type XsdGoPkgWalkHandlers struct {
	...
	XsdGoPkgHasElems_IDENTIFIERSallEXPERIMENTREFsequenceRunTypeschema_Identifiers_TIdentifierType_                                                                                                                                                                            func(*XsdGoPkgHasElems_IDENTIFIERSallEXPERIMENTREFsequenceRunTypeschema_Identifiers_TIdentifierType_, bool) error
