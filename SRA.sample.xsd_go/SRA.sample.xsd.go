...
type XsdGoPkgHasElem_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_ struct {
	SampleAttribute *TAttributeType `xml:"SAMPLE_ATTRIBUTE"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_ instance.
func (me *XsdGoPkgHasElem_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	Anonymous public name of the sample. For example, HapMap human isolate NA12878.
type XsdGoPkgHasElems_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_ struct {
	//	Anonymous public name of the sample. For example, HapMap human isolate NA12878.
	AnonymizedNames []xsdt.String `xml:"ANONYMIZED_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_ instance.
func (me *XsdGoPkgHasElems_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	GenBank common name of the organism. Examples: human, mouse.
type XsdGoPkgHasElems_CommonNAMEallSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_ struct {
	//	GenBank common name of the organism. Examples: human, mouse.
	CommonNames []xsdt.String `xml:"COMMON_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_CommonNAMEallSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_CommonNAMEallSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_CommonNAMEallSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_ instance.
func (me *XsdGoPkgHasElems_CommonNAMEallSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_CommonNAMEallSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type XsdGoPkgHasElem_SampleLINKsequenceSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_ struct {
	SampleLink *TLinkType `xml:"SAMPLE_LINK"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_SampleLINKsequenceSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_SampleLINKsequenceSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_SampleLINKsequenceSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_ instance.
func (me *XsdGoPkgHasElem_SampleLINKsequenceSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_SampleLINKsequenceSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	Individual name of the sample. This field can be used to identify the individual identity of a sample
//	where appropriate (this is usually NOT appropriate for human subjects). Example: "Glennie" the platypus.
type XsdGoPkgHasElems_IndividualNAMEallSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_ struct {
	//	Individual name of the sample. This field can be used to identify the individual identity of a sample
	//	where appropriate (this is usually NOT appropriate for human subjects). Example: "Glennie" the platypus.
	IndividualNames []xsdt.String `xml:"INDIVIDUAL_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_IndividualNAMEallSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_IndividualNAMEallSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_IndividualNAMEallSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_ instance.
func (me *XsdGoPkgHasElems_IndividualNAMEallSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_IndividualNAMEallSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	NCBI Taxonomy Identifier. This is appropriate for individual organisms and some environmental samples.
type XsdGoPkgHasElems_TaxonIDallSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_ struct {
	//	NCBI Taxonomy Identifier. This is appropriate for individual organisms and some environmental samples.
	TaxonIds []xsdt.Int `xml:"TAXON_ID"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_TaxonIDallSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_TaxonIDallSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_TaxonIDallSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_ instance.
func (me *XsdGoPkgHasElems_TaxonIDallSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_TaxonIDallSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type XsdGoPkgWalkHandlers struct {
	...
	XsdGoPkgHasElem_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_                                                                                                    func(*XsdGoPkgHasElem_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_, bool) error
	...
	XsdGoPkgHasElems_IndividualNAMEallSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_                                                                                                                                                          func(*XsdGoPkgHasElems_IndividualNAMEallSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_, bool) error
	...
	XsdGoPkgHasElems_TaxonIDallSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_                                                                                                                                                                           func(*XsdGoPkgHasElems_TaxonIDallSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_, bool) error
	...
	XsdGoPkgHasElem_SampleLINKsequenceSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_                                                                                                                                                              func(*XsdGoPkgHasElem_SampleLINKsequenceSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_, bool) error
	...
	XsdGoPkgHasElems_CommonNAMEallSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_                                                                                                                                                                  func(*XsdGoPkgHasElems_CommonNAMEallSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_, bool) error
	...
	XsdGoPkgHasElems_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_                                                                                                                          func(*XsdGoPkgHasElems_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_, bool) error
