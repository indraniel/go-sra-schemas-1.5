...
//	SAMPLE_SET serves as a container for a set of samples and a name space for establishing referential integrity
//	between them.
...
type XsdGoPkgHasElem_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_ struct {
	//	Free-form text describing the sample, its origin, and its method of isolation.
	Description xsdt.String `xml:"DESCRIPTION"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElem_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_ instance.
func (me *XsdGoPkgHasElem_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_; me != nil {
		if fn != nil {
...
type XsdGoPkgHasElems_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_ struct {
	SampleLinks []*TLinkType `xml:"SAMPLE_LINK"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_ instance.
func (me *XsdGoPkgHasElems_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		for _, x := range me.SampleLinks {
...
type TxsdSampleTypeSequenceSampleLinks struct {
	XsdGoPkgHasElems_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_
}

//	If the WalkHandlers.TxsdSampleTypeSequenceSampleLinks function is not nil (ie. was set by outside code), calls it with this TxsdSampleTypeSequenceSampleLinks instance as the single argument. Then calls the Walk() method on 1/1 embed(s) and 0/0 field(s) belonging to this TxsdSampleTypeSequenceSampleLinks instance.
func (me *TxsdSampleTypeSequenceSampleLinks) Walk() (err error) {
	if fn := WalkHandlers.TxsdSampleTypeSequenceSampleLinks; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		if err = me.XsdGoPkgHasElems_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
type XsdGoPkgHasElem_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_ struct {
	//	Links to resources related to this sample or sample set (publication, datasets, online databases).
	SampleLinks *TxsdSampleTypeSequenceSampleLinks `xml:"SAMPLE_LINKS"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_ instance.
func (me *XsdGoPkgHasElem_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		if err = me.SampleLinks.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
//	Properties and attributes of a sample. These can be entered as free-form tag-value pairs. For certain studies,
...
type XsdGoPkgHasElems_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_ struct {
	SampleAttributes []*TAttributeType `xml:"SAMPLE_ATTRIBUTE"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_ instance.
func (me *XsdGoPkgHasElems_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		for _, x := range me.SampleAttributes {
			if err = x.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
...
type TxsdSampleTypeSequenceSampleAttributes struct {
	XsdGoPkgHasElems_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_
}

//	If the WalkHandlers.TxsdSampleTypeSequenceSampleAttributes function is not nil (ie. was set by outside code), calls it with this TxsdSampleTypeSequenceSampleAttributes instance as the single argument. Then calls the Walk() method on 1/1 embed(s) and 0/0 field(s) belonging to this TxsdSampleTypeSequenceSampleAttributes instance.
func (me *TxsdSampleTypeSequenceSampleAttributes) Walk() (err error) {
	if fn := WalkHandlers.TxsdSampleTypeSequenceSampleAttributes; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		if err = me.XsdGoPkgHasElems_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
type XsdGoPkgHasElem_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_ struct {
	//	Properties and attributes of a sample. These can be entered as free-form tag-value pairs. For certain studies,
	//	submitters may be asked to follow a community established ontology when describing the work.
	SampleAttributes *TxsdSampleTypeSequenceSampleAttributes `xml:"SAMPLE_ATTRIBUTES"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_ instance.
func (me *XsdGoPkgHasElem_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		if err = me.SampleAttributes.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
type XsdGoPkgHasElem_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_ struct {
	//	List of primary and alternate identifiers including those records replacing or replaced by this record.
	Identifiers *TIdentifierType `xml:"IDENTIFIERS"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_ instance.
func (me *XsdGoPkgHasElem_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type XsdGoPkgHasElem_TITLEsequenceSampleTypeschema_Title_XsdtString_ struct {
	//	Short text that can be used to call out sample records in search results or in displays.
	Title xsdt.String `xml:"TITLE"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_TITLEsequenceSampleTypeschema_Title_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_TITLEsequenceSampleTypeschema_Title_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElem_TITLEsequenceSampleTypeschema_Title_XsdtString_ instance.
func (me *XsdGoPkgHasElem_TITLEsequenceSampleTypeschema_Title_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_TITLEsequenceSampleTypeschema_Title_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type XsdGoPkgHasElem_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_ struct {
	//	Anonymous public name of the sample. For example, HapMap human isolate NA12878.
	AnonymizedName xsdt.String `xml:"ANONYMIZED_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElem_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_ instance.
func (me *XsdGoPkgHasElem_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	Individual name of the sample. This field can be used to identify the individual identity of a sample
//	where appropriate (this is usually NOT appropriate for human subjects). Example: "Glennie" the platypus.
type XsdGoPkgHasElem_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_ struct {
	//	Individual name of the sample. This field can be used to identify the individual identity of a sample
	//	where appropriate (this is usually NOT appropriate for human subjects). Example: "Glennie" the platypus.
	IndividualName xsdt.String `xml:"INDIVIDUAL_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElem_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_ instance.
func (me *XsdGoPkgHasElem_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	NCBI Taxonomy Identifier. This is appropriate for individual organisms and some environmental samples.
type XsdGoPkgHasElem_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_ struct {
	//	NCBI Taxonomy Identifier. This is appropriate for individual organisms and some environmental samples.
	TaxonId xsdt.Int `xml:"TAXON_ID"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElem_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_ instance.
func (me *XsdGoPkgHasElem_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	Scientific name of sample that distinguishes its taxonomy. Please use a name or synonym that is tracked
//	in the INSDC Taxonomy database. Also, this field can be used to confirm the TAXON_ID setting.
type XsdGoPkgHasElem_ScientificNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_ struct {
	//	Scientific name of sample that distinguishes its taxonomy. Please use a name or synonym that is tracked
	//	in the INSDC Taxonomy database. Also, this field can be used to confirm the TAXON_ID setting.
	ScientificName xsdt.String `xml:"SCIENTIFIC_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_ScientificNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_ScientificNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElem_ScientificNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_ instance.
func (me *XsdGoPkgHasElem_ScientificNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_ScientificNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type XsdGoPkgHasElem_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_ struct {
	//	GenBank common name of the organism. Examples: human, mouse.
	CommonName xsdt.String `xml:"COMMON_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElem_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_ instance.
func (me *XsdGoPkgHasElem_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type TxsdSampleTypeSequenceSampleName struct {
	//	Scientific name of sample that distinguishes its taxonomy. Please use a name or synonym that is tracked
	//	in the INSDC Taxonomy database. Also, this field can be used to confirm the TAXON_ID setting.
	XsdGoPkgHasElem_ScientificNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_

	//	GenBank common name of the organism. Examples: human, mouse.
	XsdGoPkgHasElem_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_

	//	Anonymous public name of the sample. For example, HapMap human isolate NA12878.
	XsdGoPkgHasElem_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_

	//	Individual name of the sample. This field can be used to identify the individual identity of a sample
	//	where appropriate (this is usually NOT appropriate for human subjects). Example: "Glennie" the platypus.
	XsdGoPkgHasElem_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_

	//	NCBI Taxonomy Identifier. This is appropriate for individual organisms and some environmental samples.
	XsdGoPkgHasElem_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_
}

//	If the WalkHandlers.TxsdSampleTypeSequenceSampleName function is not nil (ie. was set by outside code), calls it with this TxsdSampleTypeSequenceSampleName instance as the single argument. Then calls the Walk() method on 5/5 embed(s) and 0/0 field(s) belonging to this TxsdSampleTypeSequenceSampleName instance.
func (me *TxsdSampleTypeSequenceSampleName) Walk() (err error) {
	if fn := WalkHandlers.TxsdSampleTypeSequenceSampleName; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		if err = me.XsdGoPkgHasElem_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if err = me.XsdGoPkgHasElem_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if err = me.XsdGoPkgHasElem_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if err = me.XsdGoPkgHasElem_ScientificNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if err = me.XsdGoPkgHasElem_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
type XsdGoPkgHasElem_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_ struct {
	SampleName *TxsdSampleTypeSequenceSampleName `xml:"SAMPLE_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_ instance.
func (me *XsdGoPkgHasElem_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		if err = me.SampleName.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
type TSampleType struct {
	XsdGoPkgHasElem_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_

	//	Free-form text describing the sample, its origin, and its method of isolation.
	XsdGoPkgHasElem_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_

	//	Links to resources related to this sample or sample set (publication, datasets, online databases).
	XsdGoPkgHasElem_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_

	//	Properties and attributes of a sample. These can be entered as free-form tag-value pairs. For certain studies,
	//	submitters may be asked to follow a community established ontology when describing the work.
	XsdGoPkgHasElem_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_

	XsdGoPkgHasAtts_NameGroup

	//	List of primary and alternate identifiers including those records replacing or replaced by this record.
	XsdGoPkgHasElem_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_

	//	Short text that can be used to call out sample records in search results or in displays.
	XsdGoPkgHasElem_TITLEsequenceSampleTypeschema_Title_XsdtString_
}

//	If the WalkHandlers.TSampleType function is not nil (ie. was set by outside code), calls it with this TSampleType instance as the single argument. Then calls the Walk() method on 6/7 embed(s) and 0/0 field(s) belonging to this TSampleType instance.
func (me *TSampleType) Walk() (err error) {
	if fn := WalkHandlers.TSampleType; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		if err = me.XsdGoPkgHasElem_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if err = me.XsdGoPkgHasElem_TITLEsequenceSampleTypeschema_Title_XsdtString_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if err = me.XsdGoPkgHasElem_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if err = me.XsdGoPkgHasElem_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if err = me.XsdGoPkgHasElem_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if err = me.XsdGoPkgHasElem_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
type XsdGoPkgHasElems_SAMPLEsequenceSampleSetTypeschema_Sample_TSampleType_ struct {
	Samples []*TSampleType `xml:"SAMPLE"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_SAMPLEsequenceSampleSetTypeschema_Sample_TSampleType_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_SAMPLEsequenceSampleSetTypeschema_Sample_TSampleType_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_SAMPLEsequenceSampleSetTypeschema_Sample_TSampleType_ instance.
func (me *XsdGoPkgHasElems_SAMPLEsequenceSampleSetTypeschema_Sample_TSampleType_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_SAMPLEsequenceSampleSetTypeschema_Sample_TSampleType_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		for _, x := range me.Samples {
			if err = x.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
...
type TSampleSetType struct {
	XsdGoPkgHasElems_SAMPLEsequenceSampleSetTypeschema_Sample_TSampleType_
}

//	If the WalkHandlers.TSampleSetType function is not nil (ie. was set by outside code), calls it with this TSampleSetType instance as the single argument. Then calls the Walk() method on 1/1 embed(s) and 0/0 field(s) belonging to this TSampleSetType instance.
func (me *TSampleSetType) Walk() (err error) {
	if fn := WalkHandlers.TSampleSetType; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		if err = me.XsdGoPkgHasElems_SAMPLEsequenceSampleSetTypeschema_Sample_TSampleType_.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
type XsdGoPkgHasElem_SampleSet struct {
	//	SAMPLE_SET serves as a container for a set of samples and a name space for establishing referential integrity
	//	between them.
	SampleSet *TSampleSetType `xml:"SAMPLE_SET"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_SampleSet function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_SampleSet instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_SampleSet instance.
func (me *XsdGoPkgHasElem_SampleSet) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_SampleSet; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		if err = me.SampleSet.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
//	SAMPLE_SET serves as a container for a set of samples and a name space for establishing referential integrity
//	between them.
type XsdGoPkgHasElems_SampleSet struct {
	//	SAMPLE_SET serves as a container for a set of samples and a name space for establishing referential integrity
	//	between them.
	SampleSets []*TSampleSetType `xml:"SAMPLE_SET"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_SampleSet function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_SampleSet instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_SampleSet instance.
func (me *XsdGoPkgHasElems_SampleSet) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_SampleSet; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		for _, x := range me.SampleSets {
			if err = x.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
...
type XsdGoPkgHasElem_Sample struct {
	Sample *TSampleType `xml:"SAMPLE"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_Sample function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_Sample instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_Sample instance.
func (me *XsdGoPkgHasElem_Sample) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_Sample; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		if err = me.Sample.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
//	Scientific name of sample that distinguishes its taxonomy. Please use a name or synonym that is tracked
//	in the INSDC Taxonomy database. Also, this field can be used to confirm the TAXON_ID setting.
type XsdGoPkgHasElems_ScientificNAMEallSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_ struct {
	//	Scientific name of sample that distinguishes its taxonomy. Please use a name or synonym that is tracked
	//	in the INSDC Taxonomy database. Also, this field can be used to confirm the TAXON_ID setting.
	ScientificNames []xsdt.String `xml:"SCIENTIFIC_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_ScientificNAMEallSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_ScientificNAMEallSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_ScientificNAMEallSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_ instance.
func (me *XsdGoPkgHasElems_ScientificNAMEallSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_ScientificNAMEallSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	List of primary and alternate identifiers including those records replacing or replaced by this record.
type XsdGoPkgHasElems_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_ struct {
	//	List of primary and alternate identifiers including those records replacing or replaced by this record.
	Identifierses []*TIdentifierType `xml:"IDENTIFIERS"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_ instance.
func (me *XsdGoPkgHasElems_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	Short text that can be used to call out sample records in search results or in displays.
type XsdGoPkgHasElems_TITLEsequenceSampleTypeschema_Title_XsdtString_ struct {
	//	Short text that can be used to call out sample records in search results or in displays.
	Titles []xsdt.String `xml:"TITLE"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_TITLEsequenceSampleTypeschema_Title_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_TITLEsequenceSampleTypeschema_Title_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_TITLEsequenceSampleTypeschema_Title_XsdtString_ instance.
func (me *XsdGoPkgHasElems_TITLEsequenceSampleTypeschema_Title_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_TITLEsequenceSampleTypeschema_Title_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	Links to resources related to this sample or sample set (publication, datasets, online databases).
type XsdGoPkgHasElems_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_ struct {
	//	Links to resources related to this sample or sample set (publication, datasets, online databases).
	SampleLinkses []*TxsdSampleTypeSequenceSampleLinks `xml:"SAMPLE_LINKS"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_ instance.
func (me *XsdGoPkgHasElems_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		for _, x := range me.SampleLinkses {
			if err = x.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
...
type XsdGoPkgHasElems_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_ struct {
	SampleNames []*TxsdSampleTypeSequenceSampleName `xml:"SAMPLE_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_ instance.
func (me *XsdGoPkgHasElems_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		for _, x := range me.SampleNames {
			if err = x.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
...
//	GenBank common name of the organism. Examples: human, mouse.
type XsdGoPkgHasElems_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_ struct {
	//	GenBank common name of the organism. Examples: human, mouse.
	CommonNames []xsdt.String `xml:"COMMON_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_ instance.
func (me *XsdGoPkgHasElems_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	NCBI Taxonomy Identifier. This is appropriate for individual organisms and some environmental samples.
type XsdGoPkgHasElems_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_ struct {
	//	NCBI Taxonomy Identifier. This is appropriate for individual organisms and some environmental samples.
	TaxonIds []xsdt.Int `xml:"TAXON_ID"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_ instance.
func (me *XsdGoPkgHasElems_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
type XsdGoPkgHasElem_SampleATTRIBUTEsequenceSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_ struct {
	SampleAttribute *TAttributeType `xml:"SAMPLE_ATTRIBUTE"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_SampleATTRIBUTEsequenceSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_SampleATTRIBUTEsequenceSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_SampleATTRIBUTEsequenceSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_ instance.
func (me *XsdGoPkgHasElem_SampleATTRIBUTEsequenceSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_SampleATTRIBUTEsequenceSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		if err = me.SampleAttribute.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
//	Free-form text describing the sample, its origin, and its method of isolation.
type XsdGoPkgHasElems_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_ struct {
	//	Free-form text describing the sample, its origin, and its method of isolation.
	Descriptions []xsdt.String `xml:"DESCRIPTION"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_ instance.
func (me *XsdGoPkgHasElems_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	Anonymous public name of the sample. For example, HapMap human isolate NA12878.
type XsdGoPkgHasElems_AnonymizedNAMEallSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_ struct {
	//	Anonymous public name of the sample. For example, HapMap human isolate NA12878.
	AnonymizedNames []xsdt.String `xml:"ANONYMIZED_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_AnonymizedNAMEallSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_AnonymizedNAMEallSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_AnonymizedNAMEallSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_ instance.
func (me *XsdGoPkgHasElems_AnonymizedNAMEallSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_AnonymizedNAMEallSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
//	Properties and attributes of a sample. These can be entered as free-form tag-value pairs. For certain studies,
//	submitters may be asked to follow a community established ontology when describing the work.
type XsdGoPkgHasElems_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_ struct {
	//	Properties and attributes of a sample. These can be entered as free-form tag-value pairs. For certain studies,
	//	submitters may be asked to follow a community established ontology when describing the work.
	SampleAttributeses []*TxsdSampleTypeSequenceSampleAttributes `xml:"SAMPLE_ATTRIBUTES"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_ instance.
func (me *XsdGoPkgHasElems_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		for _, x := range me.SampleAttributeses {
			if err = x.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
...
type XsdGoPkgHasElem_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_ struct {
	SampleLink *TLinkType `xml:"SAMPLE_LINK"`
}

//	If the WalkHandlers.XsdGoPkgHasElem_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElem_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 1/1 field(s) belonging to this XsdGoPkgHasElem_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_ instance.
func (me *XsdGoPkgHasElem_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElem_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
		}
		if err = me.SampleLink.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
//	Individual name of the sample. This field can be used to identify the individual identity of a sample
//	where appropriate (this is usually NOT appropriate for human subjects). Example: "Glennie" the platypus.
type XsdGoPkgHasElems_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_ struct {
	//	Individual name of the sample. This field can be used to identify the individual identity of a sample
	//	where appropriate (this is usually NOT appropriate for human subjects). Example: "Glennie" the platypus.
	IndividualNames []xsdt.String `xml:"INDIVIDUAL_NAME"`
}

//	If the WalkHandlers.XsdGoPkgHasElems_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_ function is not nil (ie. was set by outside code), calls it with this XsdGoPkgHasElems_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_ instance as the single argument. Then calls the Walk() method on 0/0 embed(s) and 0/1 field(s) belonging to this XsdGoPkgHasElems_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_ instance.
func (me *XsdGoPkgHasElems_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasElems_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
var (
	...
	//	Provides 181 strong-typed hooks for your own custom handler functions to be invoked when the Walk() method is called on any instance of any (non-attribute-related) struct type defined in this package.
...
type XsdGoPkgWalkHandlers struct {
	...
	XsdGoPkgHasElem_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_                                                                                                                                                          func(*XsdGoPkgHasElem_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_, bool) error
	...
	XsdGoPkgHasElems_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_                                                                                                                                                      func(*XsdGoPkgHasElems_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_, bool) error
	...
	XsdGoPkgHasElem_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_                                                                                                                                                                              func(*XsdGoPkgHasElem_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_, bool) error
	...
	XsdGoPkgHasElem_Sample                                                                                                                                                                                                                                   func(*XsdGoPkgHasElem_Sample, bool) error
	...
	XsdGoPkgHasElem_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_                                                                                                                           func(*XsdGoPkgHasElem_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_, bool) error
	XsdGoPkgHasElems_SAMPLEsequenceSampleSetTypeschema_Sample_TSampleType_                                                                                                                                                                                   func(*XsdGoPkgHasElems_SAMPLEsequenceSampleSetTypeschema_Sample_TSampleType_, bool) error
	XsdGoPkgHasElem_SampleSet                                                                                                                                                                                                                                func(*XsdGoPkgHasElem_SampleSet, bool) error
	...
	XsdGoPkgHasElems_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_                                                                                                                            func(*XsdGoPkgHasElems_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_, bool) error
	...
	XsdGoPkgHasElems_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_                                                                                                                                                         func(*XsdGoPkgHasElems_SampleNAMEsequenceSampleTypeschema_SampleName_TxsdSampleTypeSequenceSampleName_, bool) error
	...
	XsdGoPkgHasElem_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_                                                                                                                                   func(*XsdGoPkgHasElem_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_, bool) error
	...
	XsdGoPkgHasElem_TITLEsequenceSampleTypeschema_Title_XsdtString_                                                                                                                                                                                          func(*XsdGoPkgHasElem_TITLEsequenceSampleTypeschema_Title_XsdtString_, bool) error
	...
	XsdGoPkgHasElems_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_                                                                                                   func(*XsdGoPkgHasElems_SampleATTRIBUTEsequenceTxsdSampleTypeSequenceSampleAttributesSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_, bool) error
	...
	XsdGoPkgHasElems_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_                                                                                                                          func(*XsdGoPkgHasElems_IndividualNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_IndividualName_XsdtString_, bool) error
	...
	XsdGoPkgHasElems_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_                                                                                                                                                                             func(*XsdGoPkgHasElems_DESCRIPTIONsequenceSampleTypeschema_Description_XsdtString_, bool) error
	...
	XsdGoPkgHasElems_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_                                                                                                                                       func(*XsdGoPkgHasElems_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_, bool) error
	...
	XsdGoPkgHasElems_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_                                                                                                                                           func(*XsdGoPkgHasElems_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_, bool) error
	...
	TxsdSampleTypeSequenceSampleAttributes                                                                                                                                                                                                                   func(*TxsdSampleTypeSequenceSampleAttributes, bool) error
	XsdGoPkgHasElem_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_                                                                                                                           func(*XsdGoPkgHasElem_AnonymizedNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_, bool) error
	...
	XsdGoPkgHasElem_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_                                                                                                                                        func(*XsdGoPkgHasElem_SampleATTRIBUTESsequenceSampleTypeschema_SampleAttributes_TxsdSampleTypeSequenceSampleAttributes_, bool) error
	XsdGoPkgHasElem_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_                                                                                                                                            func(*XsdGoPkgHasElem_TaxonIDallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_TaxonId_XsdtInt_, bool) error
	...
	XsdGoPkgHasElems_TITLEsequenceSampleTypeschema_Title_XsdtString_                                                                                                                                                                                         func(*XsdGoPkgHasElems_TITLEsequenceSampleTypeschema_Title_XsdtString_, bool) error
	XsdGoPkgHasElems_IDallXRefTypeschema_Id_XsdtString_                                                                                                                                                                                                      func(*XsdGoPkgHasElems_IDallXRefTypeschema_Id_XsdtString_, bool) error
	TxsdSampleTypeSequenceSampleName                                                                                                                                                                                                                         func(*TxsdSampleTypeSequenceSampleName, bool) error
	...
	XsdGoPkgHasElem_ScientificNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_                                                                                                                           func(*XsdGoPkgHasElem_ScientificNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_, bool) error
	...
	XsdGoPkgHasElems_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_                                                                                                                                  func(*XsdGoPkgHasElems_CommonNAMEallTxsdSampleTypeSequenceSampleNameSAMPLENAMEsequenceSampleTypeschema_CommonName_XsdtString_, bool) error
	XsdGoPkgHasElem_SampleATTRIBUTEsequenceSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_                                                                                                                                          func(*XsdGoPkgHasElem_SampleATTRIBUTEsequenceSAMPLEATTRIBUTESsequenceSampleTypeschema_SampleAttribute_TAttributeType_, bool) error
	...
	XsdGoPkgHasElem_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_                                                                                                                                                                         func(*XsdGoPkgHasElem_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_, bool) error
	...
	XsdGoPkgHasElems_AnonymizedNAMEallSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_                                                                                                                                                          func(*XsdGoPkgHasElems_AnonymizedNAMEallSAMPLENAMEsequenceSampleTypeschema_AnonymizedName_XsdtString_, bool) error
	...
	XsdGoPkgHasElems_SampleSet                                                                                                                                                                                                                               func(*XsdGoPkgHasElems_SampleSet, bool) error
	...
	XsdGoPkgHasElem_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_                                                                                                                             func(*XsdGoPkgHasElem_SampleLINKsequenceTxsdSampleTypeSequenceSampleLinksSAMPLELINKSsequenceSampleTypeschema_SampleLink_TLinkType_, bool) error
	...
	TSampleType                                                                                                                                                                                                                                              func(*TSampleType, bool) error
	TSampleSetType                                                                                                                                                                                                                                           func(*TSampleSetType, bool) error
	XsdGoPkgHasElems_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_                                                                                                                                                                        func(*XsdGoPkgHasElems_IDENTIFIERSsequenceSampleTypeschema_Identifiers_TIdentifierType_, bool) error
	...
	TxsdSampleTypeSequenceSampleLinks                                                                                                                                                                                                                        func(*TxsdSampleTypeSequenceSampleLinks, bool) error
	...
	XsdGoPkgHasElems_ScientificNAMEallSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_                                                                                                                                                          func(*XsdGoPkgHasElems_ScientificNAMEallSAMPLENAMEsequenceSampleTypeschema_ScientificName_XsdtString_, bool) error
	...
	XsdGoPkgHasElem_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_                                                                                                                                                       func(*XsdGoPkgHasElem_SampleLINKSsequenceSampleTypeschema_SampleLinks_TxsdSampleTypeSequenceSampleLinks_, bool) error
