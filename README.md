...
you can create example code like this:
...
go to `$GOPATH/src/github.com/indraniel/go-sra-schemas-1.5` and do the following:

    $ make prepare
    $ make
    $ make tidy

Please note that that [go-xsd]'s `xsd-makepkg` command declares the
