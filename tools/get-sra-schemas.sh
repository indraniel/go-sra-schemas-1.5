...
# create the *.go files
xsd-makepkg -basepath=github.com/indraniel/go-sra-schemas-1.5 -gofmt=true -local=true -uri="SRA.analysis.xsd"
xsd-makepkg -basepath=github.com/indraniel/go-sra-schemas-1.5 -gofmt=true -local=true -uri="SRA.common.xsd"
xsd-makepkg -basepath=github.com/indraniel/go-sra-schemas-1.5 -gofmt=true -local=true -uri="SRA.experiment.xsd"
xsd-makepkg -basepath=github.com/indraniel/go-sra-schemas-1.5 -gofmt=true -local=true -uri="SRA.run.xsd"
xsd-makepkg -basepath=github.com/indraniel/go-sra-schemas-1.5 -gofmt=true -local=true -uri="SRA.sample.xsd"
xsd-makepkg -basepath=github.com/indraniel/go-sra-schemas-1.5 -gofmt=true -local=true -uri="SRA.study.xsd"
xsd-makepkg -basepath=github.com/indraniel/go-sra-schemas-1.5 -gofmt=true -local=true -uri="SRA.submission.xsd"
...
for gofile in $(find . -name "*.go" -maxdepth 2 -print); do
    perl -n -i -e 'if ($. == 11) { print qq|type XsdtString struct{ SubmitterId string `xml:",innerxml"` }\n\n| } else { print $_ }' $gofile
done
